 ...
 *
 * @todo If there is no more free block, //TODO
 *
...
/**
 * @brief Invalidate the virtual slice specified by the given LSA.
 *
 * To invalidate a virtual slice, //TODO
 *
