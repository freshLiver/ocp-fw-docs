...
#define MAIN_BLOCKS_PER_LUN     4096 /* number of blocks in the main space of a die */
...
#define USER_CHANNELS       4        // (NUMBER_OF_CONNECTED_CHANNEL) // user configurable factor
